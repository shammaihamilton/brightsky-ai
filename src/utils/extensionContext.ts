...
export class ExtensionContext {
  ...
  static showContextError(): void {
    console.warn('Extension was reloaded. Please refresh the page to continue using the AI widget.');
    ...
    `;
    notification.textContent = '⚠️ Extension reloaded. Please refresh the page to continue using the AI widget.';
