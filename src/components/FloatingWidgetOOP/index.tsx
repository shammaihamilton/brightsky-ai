  ...
  const FloatingWidgetOOPInner: React.FC = () => {
    ...
    const { handleClearConversationClick, handleChatToggle, handleClickOutside, eventService } = useWidgetEventHandlers();
      ...
      >
        ...
        {widgetState.isPanelOpen && (
          <ChatPanel
            ...
            onSend={(message) => eventService.handleSendMessage(message)}
