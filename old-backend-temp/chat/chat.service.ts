...
export class ChatService {
  ...
  private dataSource: { query: (sql: string) => Promise<unknown[]> } | null =
    null;
...
Keep the response conversational and easy to understand.`;
  ...
  private async executeQuery(
    ...
    try {
      ...
      // Temporarily return mock data while database is disabled
      // const result = [{ message: "Database temporarily disabled", query: sqlQuery }];
